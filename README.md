# 🏛️ Municipalidad App - Entrega Parcial 1
...
La plataforma busca:
- Centralizar trámites municipales.
- Mejorar la comunicación entre ciudadanos y funcionarios.
- Entregar mayor transparencia durante el proceso de atención y resolución de solicitudes.
